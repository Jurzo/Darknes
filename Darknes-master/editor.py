...
class EditorInstance:
    def __init__(self):
        ...
        self.brush = 1
        self.hotkeys = {pygame.K_0: 0, pygame.K_1: 1, pygame.K_2: 2, pygame.K_3: 3, pygame.K_4: 4, pygame.K_5: 5, pygame.K_6: 6, pygame.K_7: 7}
        self.block_types = ['air', 'wall', 'player spawn', 'monster spawn', 'finish', 'half wall', 'sound Source', 'sound source 2']
        self.colors = [(0, 0, 0), (255, 255, 255), (0, 255, 0), (255, 0, 0), (0, 0, 255), (127,127,127), (0,255,255), (255,255,0)]
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_t:
                    self.time_limit = int(input('set time limit for map (in seconds): '))
    ...
    def save_level(self):
        ...
        if filename:
            with open(filename, 'w') as file:
                file.write('# %dx%d; %d\n' % (self.level.width, self.level.height, self.time_limit))
