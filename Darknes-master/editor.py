...
class EditorInstance:
    def __init__(self):
        ...
        self.brush = 1
        self.hotkeys = {pygame.K_0: 0, pygame.K_1: 1, pygame.K_2: 2, pygame.K_3: 3, pygame.K_4: 4, pygame.K_5: 5}
        self.block_types = ['air', 'wall', 'player spawn', 'monster spawn', 'finish', 'half wall']
