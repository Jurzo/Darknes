...
class EditorInstance:
    def __init__(self):
        ...
        self.brush = 1
        self.hotkeys = {pygame.K_0: 0, pygame.K_1: 1, pygame.K_2: 2, pygame.K_3: 3, pygame.K_4: 4}
        self.block_types = ['air', 'wall', 'player spawn', 'monster spawn', 'finish']
        self.colors = [(0, 0, 0), (255, 255, 255), (0, 255, 0), (255, 0, 0), (0, 0, 255)]
    ...
    def one_loop(self):
        ...
        if pygame.mouse.get_pressed()[0] == True:
            ...
            xpos //= self.block_size
            ypos //= self.block_size
